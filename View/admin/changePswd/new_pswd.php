        ...
        <main class=" bg-secondary">
          <div class="container">
                <div class="row">
                    ...
                    <h1 class=" display-4 py-1 text-truncate ">Admin</h1>
                    <div class="form-group">
                        <form action="../../../Controller/newPassword.php">
                        <label>New Password</label>
                        <div class='row mt-4'>
                            <div class="col">
                            <input type="password" class="form-control col-form-label ml-5" name="newPassword"  id="newPassword">
                            </div>
                            <div class="col">
                            <button type="submit" name="enter" method="post" class="btn mr-5 btn-primary">Login</button>
                            </div>
                        </form>
                        </div>
                    </div>
